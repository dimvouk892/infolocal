...
class StoreBusinessRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        ], ImageUploadService::validationRules(true, 'featured_image'), ImageUploadService::validationRules(false, 'logo'), ImageUploadService::galleryValidationRules('gallery'));
    }

    public function messages(): array
    {
        return [
            'featured_image.required' => 'The featured image is required when creating a business.',
